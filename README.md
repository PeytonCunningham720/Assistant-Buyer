...
To find this folder, scroll to the top of this page and select **retail-buying-analyzer**. Then, select **output** < **charts** < **(any file within this folder)**. There are 13 visualizations generated by the project to look through!
...
git clone https://github.com/PeytonCunningham720/retail-buying-analyzer.git
